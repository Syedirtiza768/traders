...
CUSTOM_FIELDS = [
    ...
    # ── Commercial Opportunity links (OPP PRD) ───────────────────────
    {
        ...
        "in_standard_filter": 1,
        "description": "Parent Project (Trader Opportunity) when the Projects module is enabled.",
    },
    {
        "dt": "Sales Order",
        "fieldname": "trader_opportunity",
        ...
        "insert_after": "customer",
        "in_standard_filter": 1,
        "description": "Parent Project (Order Confirmation stage).",
    },
    {
        "dt": "Delivery Note",
        "fieldname": "trader_opportunity",
    ...
    {
        "dt": "Quotation",
        "fieldname": "trader_customer_ref",
        "label": "Customer Ref",
        "fieldtype": "Data",
        "insert_after": "trader_opportunity",
        "in_list_view": 1,
        "in_standard_filter": 1,
        "description": "Customer PO / enquiry reference printed on external quotations.",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_revision_of",
        "label": "Revision Of",
        "fieldtype": "Link",
        "options": "Quotation",
        "insert_after": "trader_customer_ref",
        "read_only": 1,
        "no_copy": 1,
        "description": "Parent quotation this revision was created from.",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_revision_label",
        "label": "Revision",
        "fieldtype": "Data",
        "insert_after": "trader_revision_of",
        "read_only": 1,
        "no_copy": 1,
        "description": "Revision label such as R1, R2.",
    },

    # ── Quotation Order Details (Sahamid-aligned commercial header) ──
    {
        "dt": "Quotation",
        "fieldname": "trader_warehouse",
        "label": "Quote Warehouse",
        "fieldtype": "Link",
        "options": "Warehouse",
        "insert_after": "trader_revision_label",
        "description": "Warehouse used for QOH display on commercial options.",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_validity_days",
        "label": "Validity Days",
        "fieldtype": "Int",
        "insert_after": "trader_warehouse",
        "description": "Quote validity in days (e.g. 5 working days).",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_pay_advance_pct",
        "label": "Advance %",
        "fieldtype": "Float",
        "insert_after": "trader_validity_days",
        "description": "Payment schedule: advance percentage.",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_pay_delivery_pct",
        "label": "Delivery %",
        "fieldtype": "Float",
        "insert_after": "trader_pay_advance_pct",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_pay_commissioning_pct",
        "label": "Commissioning %",
        "fieldtype": "Float",
        "insert_after": "trader_pay_delivery_pct",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_pay_after_pct",
        "label": "After %",
        "fieldtype": "Float",
        "insert_after": "trader_pay_commissioning_pct",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_pay_after_days",
        "label": "After Days",
        "fieldtype": "Int",
        "insert_after": "trader_pay_after_pct",
        "description": "Days after delivery/commissioning for the After % tranche.",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_gst_mode",
        "label": "GST Mode",
        "fieldtype": "Select",
        "options": "\nexclusive\ninclusive\nnone",
        "insert_after": "trader_pay_after_days",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_services",
        "label": "Services Quote",
        "fieldtype": "Check",
        "default": "0",
        "insert_after": "trader_gst_mode",
        "description": "When set, prefer services GST treatment (Sahamid 16% vs goods 18%).",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_wht_percent",
        "label": "WHT %",
        "fieldtype": "Float",
        "insert_after": "trader_services",
        "description": "Withholding tax percent (e.g. 4.5 / 6.5).",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_freight_clause",
        "label": "Freight Clause",
        "fieldtype": "Select",
        "options": "\nEXW\nFOR\nFOB\nCIF",
        "insert_after": "trader_wht_percent",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_rate_clause",
        "label": "FX Rate Clause",
        "fieldtype": "Select",
        "options": "\npkr\nusd\naed\neuro\npound",
        "insert_after": "trader_freight_clause",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_rate_validity",
        "label": "FX Rate Validity",
        "fieldtype": "Date",
        "insert_after": "trader_rate_clause",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_clause_rates",
        "label": "FX Clause Rates JSON",
        "fieldtype": "Code",
        "options": "JSON",
        "insert_after": "trader_rate_validity",
        "description": "Frozen exchange rates snapshot at quote time.",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_print_exchange",
        "label": "Print Exchange Mode",
        "fieldtype": "Select",
        "options": "0\n1\n2",
        "default": "0",
        "insert_after": "trader_clause_rates",
        "description": "0=local only, 1=local+FX, 2=FX only.",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_gst_clause",
        "label": "GST Clause",
        "fieldtype": "Data",
        "insert_after": "trader_print_exchange",
        "description": "Free-text GST clause printed on quotation.",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_deliver_to",
        "label": "Deliver To",
        "fieldtype": "Data",
        "insert_after": "trader_gst_clause",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_delivery_address",
        "label": "Delivery Address",
        "fieldtype": "Small Text",
        "insert_after": "trader_deliver_to",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_contact_person",
        "label": "Contact Person",
        "fieldtype": "Data",
        "insert_after": "trader_delivery_address",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_contact_phone",
        "label": "Contact Phone",
        "fieldtype": "Data",
        "insert_after": "trader_contact_person",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_contact_email",
        "label": "Contact Email",
        "fieldtype": "Data",
        "insert_after": "trader_contact_phone",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_delivery_date",
        "label": "Estimated Delivery Date",
        "fieldtype": "Date",
        "insert_after": "trader_contact_email",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_quote_date",
        "label": "Quote Date",
        "fieldtype": "Date",
        "insert_after": "trader_delivery_date",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_use_quote_date",
        "label": "Use Quote Date on Print",
        "fieldtype": "Check",
        "default": "0",
        "insert_after": "trader_quote_date",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_confirmed_date",
        "label": "Confirmed Order Date",
        "fieldtype": "Date",
        "insert_after": "trader_use_quote_date",
    },
    {
        "dt": "Quotation",
        "fieldname": "trader_order_comments",
        "label": "Order Comments",
        "fieldtype": "Small Text",
        "insert_after": "trader_confirmed_date",
    },
    ...
    # ── Commercial Line→Option→Item hierarchy (OPP PRD) ────────────
    {
        ...
        "insert_after": "trader_order_comments",
