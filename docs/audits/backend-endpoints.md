...
## Last Audit Basis
All `@frappe.whitelist()` decorated functions — 2026-03-19
...
| 51 | `get_sales_order_detail` | sales | `/api/method/trader_app.api.sales.get_sales_order_detail` | name | Sales Invoice Item, Sales Invoice | 🔍 Unknown |
