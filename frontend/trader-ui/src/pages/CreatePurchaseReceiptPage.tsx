  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <PageHeader
        ...
        description="Create a draft material receipt from the selected purchase order lines."
        actions={
          <>
            ...
            <button type="button" onClick={handleCreateReceipt} disabled={saving} className="btn-primary flex items-center gap-2 disabled:opacity-60">
