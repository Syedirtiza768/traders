...
import { ArrowLeft, RefreshCw, Save, BookOpen, CreditCard, FileText, Calculator } from 'lucide-react';
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <PageHeader
        ...
        description="Configure system-wide accounting defaults, invoice rules, and payment behaviour"
        actions={
          <>
            ...
            <button type="button" onClick={() => void handleSave()} disabled={saving || loading} className="btn-primary flex items-center gap-2 disabled:opacity-60">
      ...
      {loading ? (
        <LoadingBlock label="Loading accounting settings…" />
      ) : (
