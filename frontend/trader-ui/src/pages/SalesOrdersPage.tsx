  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-gray-500">Manage confirmed selling commitments between quotations and final invoicing.</p>
      </div>
      ...
      <div className="flex justify-end">
        <button onClick={() => navigate('/sales/orders/new')} className="btn-primary flex items-center gap-2">
