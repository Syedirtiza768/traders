...
import { ArrowLeft, Building2, RefreshCw, Save } from 'lucide-react';
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <PageHeader
        ...
        description="Edit company contact information, working hours, and default finance accounts"
        actions={
          <>
      ...
      {loading ? (
        <LoadingBlock label="Loading company settings…" />
      ) : (
