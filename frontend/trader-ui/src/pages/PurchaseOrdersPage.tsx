...
import { ChevronLeft, ChevronRight, FileText, Plus, Search, ShoppingCart, TrendingDown } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-end">
        <button onClick={() => navigate('/purchases/orders/new')} className="btn-primary flex items-center gap-2">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input type="text" placeholder="Search purchase orders..." defaultValue={search} onChange={(e) => debouncedSearch(e.target.value)} className="input-field pl-9" />
        </div>
      </div>
            ...
            {loading ? (
              ...
              filteredOrders.map((order) => (
                ...
                >
                  ...
                  <td className="px-6 py-3 text-sm text-gray-700">{order.supplier_name || order.supplier || '—'}</td>
